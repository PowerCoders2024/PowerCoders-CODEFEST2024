...
void CryptoUser::encryptMessage(byte key[], const std::string &input_path, byte** cipher, size_t* cipher_size, byte** authTag, size_t* authTagSz, byte** authIn, size_t* authInSz) {
...
void CryptoUser::decryptMessage(byte key[], byte* cipher, size_t ciphSzs, byte* authTag, size_t authTagSz, byte* authIn, size_t authInSz, const std::string &output_path) {
    this->cipher_suite.decryptAES(key, cipher, ciphSzs, authTag, authTagSz, authIn, authInSz, output_path);
}
