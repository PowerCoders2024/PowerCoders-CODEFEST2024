...
TEST_F(CipherSuiteTest, PerformOperation) {
	byte keyTest[32] = {0x6A, 0xC5, 0x3B, 0xF0, 0x8D, 0xA1, 0x7E, 0xB2, 0x4C, 0x1F, 0x90, 0x9E, 0x3D, 0x56, 0x2A, 0xE8,
						0x7F, 0x0C, 0xA2, 0xD4, 0xE3, 0xBF, 0x68, 0x49, 0x9A, 0x8B, 0xC0, 0x7D, 0x54, 0xB1, 0xF9, 0x6E};
	ecc_key key;
	cipherSuite.keyGenerator(key);

	ASSERT_EQ(1, cipherSuite.performOperation(true, keyTest, "../testInput.txt", "path_example_output"));
}
